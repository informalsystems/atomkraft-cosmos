...
|KeyPath|Old|New|
|-|-|-|
|`action.coins`|`None`|`<<[ amount \|-> 0, denom \|-> "muon" ], [ amount \|-> 30, denom \|-> "gluon" ], [ amount \|-> 0, denom \|-> "muon" ], [ amount \|-> 0, denom \|-> "atom" ]>>`|
...
|`action.coins[2]`|`None`|`[ amount \|-> 115792089237316195423570985008687907853269984665640564039457584007913129639937, denom \|-> "gluon" ]`|
