...
|KeyPath|Old|New|
|-|-|-|
|`action.coins[0]`|`[ amount \|-> 2, denom \|-> "muon" ]`|`[ amount \|-> 200, denom \|-> "gluon" ]`|
...
|`action.coins[0]`|`[ amount \|-> 200, denom \|-> "gluon" ]`|`[ amount \|-> 57896044618658097711785492504343953926634992332820282019728792003956564819967, denom \|-> "gluon" ]`|
