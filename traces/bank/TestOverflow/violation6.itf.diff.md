...
|`action.coins`|`None`|`<<[ amount \|-> 10, denom \|-> "muon" ], [ amount \|-> 1, denom \|-> "atom" ]>>`|
...
|`balances("Eve")`|`None`|`SetAsFun({<<"atom", 1>>, <<"muon", 10>>})`|
...
|`action.coins[1].amount`|`1`|`1809251394333065553493296640760748560207343510400633813116524750123642650621`|
...
|KeyPath|Old|New|
|-|-|-|
|`balances("Alice")("muon")`|`1809251394333065553493296640760748560207343510400633813116524750123642650613`|`1809251394333065553493296640760748560207343510400633813116524750123642650603`|
|`balances("Carol")`|`None`|`SetAsFun({<<"atom", 1809251394333065553493296640760748560207343510400633813116524750123642650621>>, <<"muon", 10>>})`|
|`balances("Alice")("atom")`|`1809251394333065553493296640760748560207343510400633813116524750123642650622`|`1`|
...
|KeyPath|Old|New|
|-|-|-|
|`action.coins[1]`|`[ amount \|-> 1809251394333065553493296640760748560207343510400633813116524750123642650621, denom \|-> "atom" ]`|`None`|
|`action.receiver`|`Carol`|`Bob`|
|`action.sender`|`Alice`|`Carol`|
|`action.coins[0]`|`[ amount \|-> 10, denom \|-> "muon" ]`|`[ amount \|-> 2, denom \|-> "muon" ]`|
