...
|`action.coins`|`None`|`<<[ amount \|-> 1809251394333065553493296640760748560207343510400633813116524750123642650624, denom \|-> "atom" ], [ amount \|-> 0, denom \|-> "atom" ], [ amount \|-> 0, denom \|-> "atom" ]>>`|
...
|`action.coins[0]`|`[ amount \|-> 1809251394333065553493296640760748560207343510400633813116524750123642650624, denom \|-> "atom" ]`|`[ amount \|-> 1, denom \|-> "muon" ]`|
...
|KeyPath|Old|New|
|-|-|-|
|`outcome`|`DUPLICATE_DENOM`|`RECEIVER_OVERFLOW`|
