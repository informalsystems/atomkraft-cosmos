...
|KeyPath|Old|New|
|-|-|-|
|`action.coins`|`None`|`<<[ amount \|-> 1, denom \|-> "muon" ], [ amount \|-> 100, denom \|-> "atom" ]>>`|
...
|`action.coins[1]`|`[ amount \|-> 100, denom \|-> "atom" ]`|`[ amount \|-> 100, denom \|-> "muon" ]`|
|`action.coins[0]`|`[ amount \|-> 1, denom \|-> "muon" ]`|`[ amount \|-> 1809251394333065553493296640760748560207343510400633813116524750123642650625, denom \|-> "atom" ]`|
...
|`action.coins[0]`|`[ amount \|-> 1809251394333065553493296640760748560207343510400633813116524750123642650625, denom \|-> "atom" ]`|`[ amount \|-> 200, denom \|-> "muon" ]`|
