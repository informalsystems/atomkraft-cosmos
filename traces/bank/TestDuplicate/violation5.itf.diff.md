...
|`action.coins[0]`|`[ amount \|-> 2, denom \|-> "muon" ]`|`[ amount \|-> 0, denom \|-> "atom" ]`|
...
|`action.coins[0]`|`None`|`[ amount \|-> 57896044618658097711785492504343953926634992332820282019728792003956564819967, denom \|-> "gluon" ]`|
