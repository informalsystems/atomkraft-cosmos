...
|KeyPath|Old|New|
|-|-|-|
|`action.coins[0]`|`[ amount \|-> 2, denom \|-> "atom" ]`|`[ amount \|-> 300, denom \|-> "gluon" ]`|
|`action.coins[1]`|`[ amount \|-> 100, denom \|-> "gluon" ]`|`[ amount \|-> 1, denom \|-> "muon" ]`|
...
|`action.coins[0]`|`[ amount \|-> 300, denom \|-> "gluon" ]`|`[ amount \|-> 115792089237316195423570985008687907853269984665640564039457584007913129639937, denom \|-> "muon" ]`|
|`action.coins[1]`|`[ amount \|-> 1, denom \|-> "muon" ]`|`[ amount \|-> 115792089237316195423570985008687907853269984665640564039457584007913129639933, denom \|-> "gluon" ]`|
