...
|`action.coins`|`None`|`<<[ amount \|-> 115792089237316195423570985008687907853269984665640564039457584007913129639934, denom \|-> "gluon" ], [ amount \|-> 0, denom \|-> "muon" ]>>`|
...
|`action.coins[1]`|`[ amount \|-> 0, denom \|-> "muon" ]`|`[ amount \|-> 0, denom \|-> "gluon" ]`|
