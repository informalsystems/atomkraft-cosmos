...
|`action.coins`|`None`|`<<[ amount \|-> 1, denom \|-> "muon" ], [ amount \|-> 20, denom \|-> "muon" ], [ amount \|-> 300, denom \|-> "muon" ], [ amount \|-> 10, denom \|-> "muon" ]>>`|
...
|`action.coins[2]`|`[ amount \|-> 300, denom \|-> "muon" ]`|`None`|
|`action.coins[3]`|`[ amount \|-> 10, denom \|-> "muon" ]`|`None`|
|`action.receiver`|`Dave`|`Bob`|
|`action.coins[0]`|`[ amount \|-> 1, denom \|-> "muon" ]`|`[ amount \|-> 100, denom \|-> "atom" ]`|
...
|`action.coins[0]`|`[ amount \|-> 100, denom \|-> "atom" ]`|`[ amount \|-> 2, denom \|-> "muon" ]`|
