...
|KeyPath|Old|New|
|-|-|-|
|`action.coins`|`None`|`<<[ amount \|-> 2, denom \|-> "atom" ], [ amount \|-> 2, denom \|-> "gluon" ]>>`|
...
|`action.coins[1].amount`|`2`|`115792089237316195423570985008687907853269984665640564039457584007913129639937`|
