...
|KeyPath|Old|New|
|-|-|-|
|`action.coins`|`None`|`<<[ amount \|-> 57896044618658097711785492504343953926634992332820282019728792003956564819965, denom \|-> "gluon" ], [ amount \|-> 3, denom \|-> "muon" ]>>`|
...
|`action.coins[0]`|`[ amount \|-> 57896044618658097711785492504343953926634992332820282019728792003956564819965, denom \|-> "gluon" ]`|`[ amount \|-> 0, denom \|-> "muon" ]`|
...
|`action.coins[0]`|`[ amount \|-> 0, denom \|-> "muon" ]`|`[ amount \|-> 0, denom \|-> "gluon" ]`|
