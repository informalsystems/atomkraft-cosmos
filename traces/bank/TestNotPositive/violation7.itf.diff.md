...
|`action.coins`|`None`|`<<[ amount \|-> 0, denom \|-> "muon" ], [ amount \|-> 0, denom \|-> "atom" ], [ amount \|-> 0, denom \|-> "muon" ], [ amount \|-> 1, denom \|-> "atom" ]>>`|
...
|`action.coins[3]`|`[ amount \|-> 1, denom \|-> "atom" ]`|`None`|
|`action.receiver`|`Eve`|`Bob`|
|`action.sender`|`Carol`|`Eve`|
|`action.coins[0]`|`[ amount \|-> 0, denom \|-> "muon" ]`|`[ amount \|-> 100, denom \|-> "atom" ]`|
...
|`action.coins[0]`|`[ amount \|-> 100, denom \|-> "atom" ]`|`[ amount \|-> 100, denom \|-> "muon" ]`|
