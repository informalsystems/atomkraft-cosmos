...
|`balances("Carol")`|`None`|`SetAsFun({<<"muon", 1>>})`|
...
|`action.coins[0]`|`[ amount \|-> 1, denom \|-> "muon" ]`|`[ amount \|-> 1809251394333065553493296640760748560207343510400633813116524750123642650621, denom \|-> "muon" ]`|
