...
|`action.coins`|`None`|`<<[ amount \|-> 1, denom \|-> "atom" ], [ amount \|-> 20, denom \|-> "atom" ], [ amount \|-> 2, denom \|-> "atom" ], [ amount \|-> 0, denom \|-> "atom" ]>>`|
...
|`action.coins[0]`|`[ amount \|-> 1, denom \|-> "atom" ]`|`[ amount \|-> 0, denom \|-> "muon" ]`|
