...
|`action.coins`|`None`|`<<[ amount \|-> 0, denom \|-> "atom" ], [ amount \|-> 200, denom \|-> "muon" ]>>`|
...
|`action.coins[1].amount`|`200`|`1809251394333065553493296640760748560207343510400633813116524750123642650624`|
