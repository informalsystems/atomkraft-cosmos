...
|`action.coins`|`None`|`<<[ amount \|-> 200, denom \|-> "muon" ], [ amount \|-> 1809251394333065553493296640760748560207343510400633813116524750123642650624, denom \|-> "atom" ]>>`|
...
|`action.coins[1]`|`[ amount \|-> 1809251394333065553493296640760748560207343510400633813116524750123642650624, denom \|-> "atom" ]`|`[ amount \|-> 0, denom \|-> "atom" ]`|
|`action.coins[0]`|`[ amount \|-> 200, denom \|-> "muon" ]`|`[ amount \|-> 2, denom \|-> "muon" ]`|
...
|`action.coins[1]`|`[ amount \|-> 0, denom \|-> "atom" ]`|`[ amount \|-> 200, denom \|-> "atom" ]`|
