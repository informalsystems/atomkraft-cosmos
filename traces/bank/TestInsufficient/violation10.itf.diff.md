...
|KeyPath|Old|New|
|-|-|-|
|`action.coins`|`None`|`<<[ amount \|-> 30, denom \|-> "atom" ], [ amount \|-> 0, denom \|-> "gluon" ], [ amount \|-> 0, denom \|-> "gluon" ], [ amount \|-> 1, denom \|-> "muon" ]>>`|
...
|`action.coins[0]`|`[ amount \|-> 30, denom \|-> "atom" ]`|`[ amount \|-> 10, denom \|-> "muon" ]`|
|`action.coins[1]`|`[ amount \|-> 0, denom \|-> "gluon" ]`|`None`|
|`action.coins[3]`|`[ amount \|-> 1, denom \|-> "muon" ]`|`None`|
