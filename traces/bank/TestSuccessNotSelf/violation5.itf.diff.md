...
|`action.coins[0]`|`[ amount \|-> 1, denom \|-> "atom" ]`|`[ amount \|-> 0, denom \|-> "gluon" ]`|
...
|`action.coins[0].amount`|`0`|`57896044618658097711785492504343953926634992332820282019728792003956564819965`|
